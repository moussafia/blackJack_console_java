...
public class Text {
    ...
    public static String BACKGROUND_PURPLE = "\u001B[45m";
    ...
    public static String UNDERLINE_OFF = "\u001B[24m";
    public static String ITALIC_OFF = "\u001B[23m";
    public static String STRIKETHROUGH_OFF = "\u001B[29m";
    public static String MAGENTA = "\u001B[35m";
    public static String ORANGE = "\u001B[38;5;208m";
    public static String BACKGROUND_MAGENTA = "\u001B[45m";
    public static String BACKGROUND_ORANGE = "\u001B[48;5;208m";
}
